...
VERSÃO WINDOWS: Otimizada para rodar em Windows PowerShell/CMD
"""
...
# ============================================================================
# CONFIGURAÇÃO DE LOGGING - OTIMIZADO PARA WINDOWS
# ============================================================================

def _configure_logging(level: int = logging.INFO, log_file: Optional[str] = None) -> logging.Logger:
    """
...
class TaskProcessor:
    ...
    def __init__(self, output_dir: Optional[str] = None) -> None:
        ...
        logger.info(f"TaskProcessor inicializado (Diretório de saída: {self.output_dir})")
    ...
    def save_results_json(self, filename: str = "task_results.json") -> str:
        """
        ...
        for task in results_data['tasks']:
...
def main() -> None:
    ...
    print("\n💾 SALVANDO RESULTADOS")
    print("-" * 80)
    results_file = processor.save_results_json()
